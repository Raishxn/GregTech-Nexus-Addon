...
public class HugeSteamOutputBus extends MultiblockPartMachine {

    protected static final ManagedFieldHolder MANAGED_FIELD_HOLDER = new ManagedFieldHolder(
            HugeSteamOutputBus.class, MultiblockPartMachine.MANAGED_FIELD_HOLDER);

    @Persisted
    public final NotifiableItemStackHandler inventory;

    public HugeSteamOutputBus(IMachineBlockEntity holder, Object... args) {
        super(holder);
        this.inventory = new NotifiableItemStackHandler(this, 64, IO.OUT, IO.OUT);
    }
