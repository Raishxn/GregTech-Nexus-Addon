...
public class GTNACreativeModeTabs {
    ...
    public static RegistryEntry<CreativeModeTab> WIRELESS = REGISTRATE.defaultCreativeTab("gtna_wireless",
            builder -> builder.displayItems(new RegistrateDisplayItemsGenerator("wireless", REGISTRATE))
    ...
    public static class RegistrateDisplayItemsGenerator implements CreativeModeTab.DisplayItemsGenerator {
        ...
        private boolean isMaterialBlockItem(Item item) {
            ...
            if (isWirelessItem(item)) return false;
        ...
        private boolean isWirelessItem(Item item) {
            // Check if this is a wireless energy/dynamo hatch or a nexus capacitor by registry name
